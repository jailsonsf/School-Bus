...
insert into address(id, name, district, number, person_id) values(2, 'rua x', 'centro', 47, 1)
insert into address(id, name, district, number, person_id) values(3, 'rua y', 'centro', 54, 2)
insert into address(id, name, district, number, person_id) values(4, 'rua z', 'centro', 36, 3)
